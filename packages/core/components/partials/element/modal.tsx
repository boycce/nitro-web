...
export function Modal({ 
  ...
  return (
    ...
    >
      <div class={`${twMerge('!absolute inset-0 box-content bg-overlay/70 transition-opacity')} ${stateObj.bg}`}></div>
      <div class={`${twMerge('relative h-[100vh] overflow-y-auto transition-[opacity,transform]')} ${stateObj.container}`}>
        <div class="flex items-center justify-center min-h-full" onMouseDown={onClick}> 
          <div 
            ...
            class={`${twMerge('relative w-full mx-6 mt-4 mb-8 bg-surface rounded-lg shadow-lg p-9', className)}`}
          >
            <div 
