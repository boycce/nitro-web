        ...
        lists.map((list, i) => {
          ...
          return (
            <div 
              key={i}
              ref={refs[type]}
              className="w-[60px] relative overflow-hidden hover:overflow-y-auto border-l border-accent sm-scrollbar first:border-l-0"
            >
                ...
                {list.map(item => (
                  ...
                  >
                    <button 
                      key={item}
                      className={
                        `${dayButtonClassName} rounded-full flex justify-center items-center group-hover:bg-accent `
